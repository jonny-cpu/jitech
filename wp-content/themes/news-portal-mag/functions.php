...
function news_portal_mag_customize_register( $wp_customize ) {
    ...
    $wp_customize->get_setting( 'news_portal_theme_color' )->default = '#ba0108';
    $wp_customize->get_setting( 'news_portal_site_title_color' )->default = '#212121';
...
if ( ! function_exists( 'news_portal_mag_dynamic_styles' ) ) :
    function news_portal_mag_dynamic_styles() {
        ...
        $news_portal_mag_theme_color = get_theme_mod( 'news_portal_theme_color', '#ba0108' );
